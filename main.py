...
MESSAGE     = 'Hi👋,我是颠佬😋,这是我的看片神器😍.' # Commit message, you can change it to whatever you want.

FAKE_COMMIT = True #Development mode, will not commit to git, and print the command to the console.
